...
# The cases and date have a direct log relationship
3. What were you not able to do due to not having the R knowledge?
# I wanted to try to frame the plot in a way that put more of an emphasis on the different races affected so I could see better the discrepancy between races affected.
4. What other data would be useful to better understand this data?
# A comparison for states
